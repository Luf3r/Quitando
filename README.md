...
O projeto está em construção. As **Fases 0 a 9** estão implementadas e verificadas; a **Fase 10 — Grupos, convites e ciclo de memberships** está na verificação integrada final. Ela acrescenta grupos com owner inicial, convites internos com transições auditáveis, reentrada no mesmo membership, saída segura, ownership, ordenação e arquivamento/restauração no nível de serviço. A Fase só será declarada concluída após o gate integrado.
...
O trabalho é acompanhado no [GitHub Project — Quitando](https://github.com/users/Luf3r/projects/2). As [Fases 3](https://github.com/Luf3r/Quitando/issues/8), [4](https://github.com/Luf3r/Quitando/issues/9), [5](https://github.com/Luf3r/Quitando/issues/10), [6](https://github.com/Luf3r/Quitando/issues/11), [7](https://github.com/Luf3r/Quitando/issues/12), [8](https://github.com/Luf3r/Quitando/issues/13) e [9](https://github.com/Luf3r/Quitando/issues/14), com suas subissues, estão em `Done`; a [Fase 10](https://github.com/Luf3r/Quitando/issues/15) está no gate integrado final. Status e campos do quadro devem refletir apenas trabalho realmente demonstrado; contratos e gates continuam definidos pela documentação do repositório.
