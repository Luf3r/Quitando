...
CI.run do
  ...
  step "Tests: RSpec", "env CI=true RAILS_ENV=test QUITANDO_DEMO_URL= QUITANDO_MAIN_URL= bundle exec rspec --exclude-pattern 'spec/system/**/*_spec.rb'"
  step "Tests: System", "env CI=true RAILS_ENV=test QUITANDO_DEMO_URL= QUITANDO_MAIN_URL= bundle exec rspec spec/system"
