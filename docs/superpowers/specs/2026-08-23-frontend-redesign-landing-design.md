...
Depois disso a Fase 14 pode voltar a `Ready`, restrita a observabilidade operacional, rate limit, secrets, backups, produção, Kamal, smoke tests, rollback e deploy real. A previsão anterior deste documento de incluir cenário de demonstração na Fase 14 foi superseded pela [extensão de 2026-08-28](./2026-08-28-demo-scenario-design.md): o cenário público demo pertence às entregas 13.15–13.16 e ao roadmap normativo.
